...
This table should be a living document and evolve with the community. Feedback including requests to add metrics can be sent to <a href="mailto:rachel_heyard@uzh.ch">Rachel Heyard</a>. Our live table is hosted on [github.com/rachelHey/reproducibility_metrics](https://github.com/rachelHey/reproducibility_metrics) and we invite anyone to suggest the addition of reproducibility metrics via github-issues.
